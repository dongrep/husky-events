...
const Contact = () => {
  return (
    <div id='contact' className=' m-auto lg-w-full p-4 py-16 items-center text-center mt-7'>
        <h2 className=' text-5xl text-centerfont-bold font-serif'>NEED HELP? JUST SEND US A MESSAGE</h2>
        ...
        <div className='grid md:grid-cols-2 mt-6'>
            ...
            <form>
                <div className="flex flex-wrap w-auto">
                    ...
                    <button className="m-2 px-80 py-3 md:px-8 xl:px-10 rounded-md bg-[#3f49d9] text-black font-bold hover:text-[#fff] mt-5 mb-5 text-xl">Submit</button>
                </div>
            </form>
        </div>
    </div>
