...
const Contact = () => {
  return (
    <div id='contact' className=' m-auto w-full p-4 py-16 items-center ml-96 text-center'>
        ...
        <div className='grid md:grid-cols-2 mt-6'>
            ...
            <form>
                <div className="flex flex-wrap">
                    ...
                    <button className="m-2 px-80 py-3 rounded-md bg-[#3f49d9] text-black font-bold hover:text-[#fff] mt-8 mb-5 text-xl">Submit</button>
                </div>
            </form>
        </div>
    </div>
